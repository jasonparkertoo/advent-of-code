...
class Day3Tests {
    private final Memory example = Memory.from(Path.of("src", "test", "resources", "examples", "day3"));
    private final Memory example2 = Memory.from(Path.of("src", "test", "resources", "examples", "day3_2"));
    private final Memory answer = Memory.from(Path.of("src", "test", "resources", "challenges", "day3"));
